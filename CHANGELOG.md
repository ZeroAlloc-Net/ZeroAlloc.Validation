...
* **generator:** generated validator constructors take ValidatorFor<TNested> for nested and collection [Validate] properties instead of the concrete nested validator. Remove hand-written registrations of nested validators by concrete type; code that names the constructor parameter types must switch to ValidatorFor<T>. See docs/migrating-to-v2.md.
* **generator:** a rule on a base-type property with no getter, or on a private or protected static base property, was dropped with a ZV0017 warning and now fails the build with ZV0027. Move the rule to a readable instance property or remove it.
* **generator:** a private nested [Validate] type used to compile because nothing was generated for it. It now fails the build with ZV0025. Make the type and every type containing it internal or public, and drop the file modifier from a file-local one.
* **generator:** a private or protected static base-type method used as a [CustomValidation] method or named by When or Unless was dropped with a ZV0017 warning and now fails the build with ZV0028. Make it a public or internal instance method, or remove the rule.
* a ValidationAttribute subclass that does not derive from ValidationAttribute<T> now fails the build with ZV0020; it was previously ignored without a diagnostic, so the property was never validated. ZV0021, ZV0023 and ZV0024 are new errors: ZV0024 reports a validation attribute on a field or parameter, which the generator does not read.
* **generator:** ZeroAllocOptionsValidationExtensions and InternalZeroAllocOptionsValidationExtensions moved from the global namespace into ZeroAlloc.Validation.Options. Callers relying on the old global-namespace lookup need to add `using ZeroAlloc.Validation.Options;` to any file that calls ValidateWithZeroAlloc.
* a project referencing both ZeroAlloc.Validation and ZeroAlloc.Validation.Generator directly, previously the documented and required combination, now fails to build with ZV9001. Remove the ZeroAlloc.Validation.Generator PackageReference; ZeroAlloc.Validation carries it now.

### Features

* bundle the generator into ZeroAlloc.Validation and drop it as a separate install ([#198](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/198)) ([7747fbe](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/7747fbe71b266e9ad928b895a3f7c879a95416d8))
* **generator:** add opt-in internal validators via ZeroAllocGeneratedAccessibility ([#201](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/201)) ([69693b1](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/69693b18c91147c7f11b8f0183a7c7445c4ae494)), closes [#193](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/193)
* **generator:** move options validation extensions out of the global namespace ([#200](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/200)) ([c69c741](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/c69c7416c5d819ea9eac94753431c82ee422f692)), closes [#193](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/193)
* **generator:** warn when [RuleMessage] is on a class that is not a custom rule ([#225](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/225)) ([eec7a8d](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/eec7a8da50414509a1b7aa45df2a996fd51c2a80)), closes [#210](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/210)
* support user-defined rule attributes via ValidationAttribute&lt;T&gt; ([#217](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/217)) ([17e26c7](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/17e26c7fff0f900ef5b3f11760e5690e0525ad11)), closes [#196](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/196) [#205](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/205) [#206](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/206)


### Bug Fixes

* **generator:** escape keyword identifiers and report colliding validator names ([#250](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/250)) ([e062777](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/e0627776fba9ee3fd9178396a73af1dcf7c9468a)), closes [#242](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/242) [#220](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/220)
* **generator:** generate validators for [Validate] models nested in other types ([#222](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/222)) ([6d9858b](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/6d9858b0d0f3ff201413e3417b302b79f0986c26)), closes [#207](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/207)
* **generator:** honour InternalsVisibleTo and inherited [CustomValidation] on overrides ([#245](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/245)) ([22c829d](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/22c829db54a258b26a0b58ac44bb9d798d85b591)), closes [#227](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/227) [#240](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/240)
* **generator:** mirror rule call warnings as ZV0032 and keep generated calls warning-free ([#257](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/257)) ([f9e42d8](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/f9e42d81fb6af33873f8e739f520494df705eb72))
* **generator:** name and locate diagnostics accurately ([#249](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/249)) ([4a1e716](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/4a1e71650a6ce84b92c7c0dcb2149d94d8038257)), closes [#214](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/214) [#215](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/215) [#221](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/221) [#235](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/235) [#236](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/236)
* **generator:** only fire ZV0016 when a rule needs auto-unwrap ([#223](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/223)) ([aade834](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/aade8343eca37a6250656071c56a7c1d1cacdd94)), closes [#203](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/203)
* **generator:** report a [Validate] type the generated validator cannot reach as ZV0025 ([#228](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/228)) ([bc0c8f2](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/bc0c8f2df3d05bd13edcd07381cdedbfe211b893)), closes [#216](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/216)
* **generator:** report a generic [Validate] model as ZV0029 ([#239](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/239)) ([322e328](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/322e3289d601596000c20953fefe862627e4b438)), closes [#219](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/219) [#238](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/238)
* **generator:** report methods the validator cannot call as ZV0028 ([#234](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/234)) ([703ccc5](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/703ccc5e9663f5774eecb86ec02048c46882cfc7))
* **generator:** report rules on properties the validator cannot read as ZV0027 ([#230](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/230)) ([3266d1d](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/3266d1d362b74325d065bdc0187cf4c9be82993a))
* **generator:** report zv0015 at the colliding behavior's attribute ([#252](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/252)) ([3596679](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/35966798b843b44e19cf056f8d3c79500120d5c9)), closes [#247](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/247)
* **generator:** report zv0024 and zv0013 once across a base type walk ([#237](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/237)) ([88a0dc8](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/88a0dc87d0c405ed5d62a8026bf4aab500b06d3a)), closes [#229](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/229) [#232](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/232)
* **generator:** resolve rule method calls as the compiler does and report unusable ones ([#244](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/244)) ([6993da8](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/6993da87c3d7c5f1f2a09e7994ecb93d876ab7f8)), closes [#231](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/231) [#233](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/233)
* **generator:** share generator test helper, real assertions, scoped EPS06/HLQ004 ([#251](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/251)) ([2610ba4](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/2610ba41bb99e491fea5e1b13291c4a574e3365b)), closes [#211](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/211) [#212](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/212) [#213](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/213) [#224](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/224)
* **generator:** substitute each message placeholder exactly once ([#218](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/218)) ([d5cc256](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/d5cc2566e527b8facbc7abf72d34d52de665dc5a)), closes [#204](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/204)
* **generator:** take nested validators as ValidatorFor in generated constructors ([#254](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/254)) ([3392b5b](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/3392b5bdc1efaaca2350ee15ddd36f0278a6c01c))
* mark released analyzer rules and public api as shipped and automate the move ([#253](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/253)) ([caeb6d1](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/caeb6d127da8568f1178ca14b7823cc8d9b2cc09))
...
* lock public API surface (PublicApiAnalyzers + api-compat gate) ([#25](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/issues/25)) ([9613e27](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/9613e27b6f1639c6d05e87c1fa08f1084e82ebb1))
...
* correct dotnet-version format (10.0.x not net10.0) ([9eb6954](https://github.com/ZeroAlloc-Net/ZeroAlloc.Validation/commit/9eb695490333939a13504e87a60e8d673401f53b))
